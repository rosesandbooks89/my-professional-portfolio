...
function Portfolio() {
    const projects = [
        ...
        },
        {
            ...
            description: " This is a PWA application that allows the user to create, edit, and delete text while offline. When the user comes back online, the text is saved to the database.",
            image: textEditor,
        ...
        {
            name: "GSD",
            description: "A task management application that allows the user to create, edit, and delete tasks. This was a group project that I worked on with 3 other developers. This was our second project as students in the UTSA Coding Bootcamp.",
            image: gsd,
        ...
        {
            name: "Yass Flix",
            description: "A search engine for movies and where to stream them. This was a group project that I worked on with 3 other developers. This was our first project as students in the UTSA Coding Bootcamp.",
            image: yassFlix,
